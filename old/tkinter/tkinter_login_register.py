...
#login button
button1 = tkinter.Button(master=root, text='Login', background='blue', foreground='white', font=('Calibri', 11, 'bold'), command=toonVenster1)
button1.pack(pady=10)

#registreer button
button2 = tkinter.Button(master=root, text='Registreer', background='blue', foreground='white', font=('Calibri', 11, 'bold'), command=toonVenster2)
button2.pack(pady=10)
